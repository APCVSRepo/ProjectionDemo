...
public class SdlAQILayoutCrystal extends SdlAQILayout
{
	...
	protected Bitmap getAQILayoutImage(int innerAQI, int outerAQI, WeatherInfo wi)
	{
		...
		RectF innerEllipse = new RectF(LAYOUT_WIDTH / 2 - 10 - 90, 90, LAYOUT_WIDTH / 2 - 10 + 85 , LAYOUT_HEIGHT - 85);
		...
		layoutCanvas.drawText("Inner PM2.5", 335, 130, mPmInnerTitlePaint);
		layoutCanvas.drawText("Outer PM2.5", 520, 130, mPmOuterTitlePaint);


		// Draw AQI value with horizontal align
		Rect innerAQITextRect = new Rect(LAYOUT_WIDTH / 2 - 60, 140, LAYOUT_WIDTH / 2 - 60 + 100, 210);
		...
		innerAQITextRect.set(LAYOUT_WIDTH/2 + 135, 140, LAYOUT_WIDTH/2 + 135 + 100, 210);
		...
		layoutCanvas.drawText(wi.windDir + wi.windLevel + "Lv", 675, 125, mWeatherPaint);
...
//		outCanvas.drawBitmap(mainLayoutBmp, 0, 0, paint);
